...
START_TEST(s21_mult_matrix_test5) {
  matrix_t A;
  matrix_t B;
  matrix_t result;
  matrix_t validate;
  ...
  validate.matrix[0][0] = 3, validate.matrix[0][1] = 34,
  validate.matrix[0][2] = 55;
  validate.matrix[1][0] = -18, validate.matrix[1][1] = 1,
  validate.matrix[1][2] = 46;
  validate.matrix[2][0] = -3, validate.matrix[2][1] = 11,
  validate.matrix[2][2] = 26;
...
START_TEST(s21_mult_matrix_test6) {
  matrix_t A = {.rows = -1, .columns = -1};
  matrix_t B = {.rows = -1, .columns = -1};
  matrix_t result;
...
Suite *s21_mult_matrix_test_suite() {
  ...
  TCase *tc_case = tcase_create("s21_mult_matrix_case");
  ...
  tcase_add_test(tc_case, s21_mult_matrix_test5);
  tcase_add_test(tc_case, s21_mult_matrix_test6);

...
START_TEST(s21_sum_matrix_test0) {
  ...
  s21_initialize_matrix(&validate, 2, 2);
...
START_TEST(s21_sum_matrix_test5) {
  matrix_t A;
  matrix_t B;
  matrix_t result;
  matrix_t validate;
  ...
  validate.matrix[0][0] = 4, validate.matrix[0][1] = 7,
  validate.matrix[0][2] = 11;
  validate.matrix[1][0] = -2, validate.matrix[1][1] = 5,
  validate.matrix[1][2] = 8;
  validate.matrix[2][0] = 5, validate.matrix[2][1] = 5,
...
START_TEST(s21_sum_matrix_test6) {
  matrix_t A;
  matrix_t B;
  matrix_t result;
  matrix_t validate;
...
START_TEST(s21_sum_matrix_test7) {
  matrix_t A = {.rows = -1, .columns = -1};
  matrix_t B = {.rows = -1, .columns = -1};
  matrix_t result;
...
Suite *s21_sum_matrix_test_suite() {
  ...
  TCase *tc_case = tcase_create("s21_sum_matrix_case");
  ...
  tcase_add_test(tc_case, s21_sum_matrix_test5);
  tcase_add_test(tc_case, s21_sum_matrix_test6);
  tcase_add_test(tc_case, s21_sum_matrix_test7);
